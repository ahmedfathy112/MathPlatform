...
/**
 * Shared by both /admin/content/upload-video and /assistant/content/upload-video
 * (both teacher and assistant are staff for RLS purposes on `videos`).
 * `redirectTo` controls where to land after a successful upload, since each
 * role has a different home for "where would I check on this next".
 */
export default function UploadVideoForm({ redirectTo = "/admin/courses" }) {
