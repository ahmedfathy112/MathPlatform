...
/**
 * Renders one package (academic year) as a subscribable/enterable card.
 * `status` should be one of the `subscription_status` enum values, or
 * `null`/`undefined` if the student has never subscribed to this package.
 */
export default function PackageCard({
  ...
  const href = isActive
    ? `/dashboard/classes/${packageId}`
    : `/dashboard/subscriptions/${packageId}`;
